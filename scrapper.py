...
#currentIndex= soup.find('div',class_='pull-right banner-green banner-item').find('div',class_='current-index').text.replace('\n','').replace(' ','').replace(',','')
#pointChange = soup.find('div',class_='pull-right banner-green banner-item').find('div',class_='point-change').text.replace('\n','').replace(' ','').replace(',','')
#percentChange = soup.find('div',class_='pull-right banner-green banner-item').find('div',class_='percent-change').text.replace('\n','').replace(' ','').replace(',','').replace('%','')
